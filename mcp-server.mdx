...
<Tabs>
  <Tab title="OAuth">
    ...
    <Tabs>
      ...
      <Tab title="Manus">
        Manus does not support OAuth. Switch to the **API Key** tab above for Manus setup instructions.
      </Tab>
      <Tab title="Cursor">
      ...
      <Tab title="Warp">
        In Warp, go to **Warp Drive > MCP Servers > + Add**, select **URL**, and enter:
  ...
  <Tab title="API Key">
    ...
    First, generate a PAT in Layer: go to **User Settings > New Token** and copy the token (starts with `pat_`).

    <Tabs>
      <Tab title="Claude.ai / Claude Desktop">
        Claude.ai and Claude Desktop support OAuth natively. Switch to the **OAuth** tab above for setup instructions.
      </Tab>
      <Tab title="Claude Code (CLI)">
        1. Open your terminal to access the CLI.
      ...
      <Tab title="Warp">
        ...
        In Warp, go to **Warp Drive > MCP Servers > + Add**, select **URL**, enter `https://mcp.app.layer.ai/mcp`, and add a header:
